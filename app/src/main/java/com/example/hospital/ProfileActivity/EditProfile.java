...
import com.example.hospital.RegistrationForm;
import com.example.hospital.databinding.ActivityEditProfileBinding;
...
public class EditProfile extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding.selectImage.setOnClickListener(v -> Dexter.withActivity(EditProfile.this).withPermissions(Manifest.permission.READ_EXTERNAL_STORAGE).withListener(new MultiplePermissionsListener() {
            @Override
        ...
        binding.submit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (binding.Name.getEditableText().toString().isEmpty()) {
                    Toast.makeText(EditProfile.this, "Enter Your Crop Name", Toast.LENGTH_SHORT).show();
