package com.example.hospital.News;
...
public class MainActivityNews extends AppCompatActivity implements  CategoryRVAdaptor.CategorClickInterface{
...
//        categoryRVModalArrayList.add(new CategoryRVModal("All","https://www.google.com/search?q=all+categories+full+hd+black+blur+background&tbm=isch&ved=2ahUKEwing_KjscTzAhXL43MBHRnRDm8Q2-cCegQIABAC&oq=all+categories+full+hd+black+blur+background&gs_lcp=ChJtb2JpbGUtZ3dzLXdpei1pbWcQAzoECAAQQzoGCAAQBxAeOgQIABANOggIABANEAUQHjoFCAAQzQI6BAghEAo6BAgeEApQ6OwBWLWRAmCelgJoAHAAeAKAAeABiAG6FJIBBjAuMTAuNJgBAKABAcABAQ&sclient=mobile-gws-wiz-img&ei=8j1lYafCGsvHz7sPmaK7-AY&bih=664&biw=360&client=ms-android-oppo-rvo3&prmd=isvxn&hl=en-US#imgrc=-8I045SPLfF3XM"));
...
//        categoryRVModalArrayList.add(new CategoryRVModal("Entertainment","https://media.istockphoto.com/photos/media-concept-smart-tv-picture-id503685712?b=1&k=20&m=503685712&s=170667a&w=0&h=01OPzR5XIyg3HQF5ziFyD566oMIE9InO8oB6GdbQe_M="));
    ...
    private void getNews(String category){
        ...
        String categoryURL = "https://newsapi.org/v2/top-headlines?country=in&category="+ category +"&apiKey=Enter Your API key";
        String url = "https://newsapi.org/v2/top-headlines?country=in&excludeDomain=stackoverflow.com&sortBy=publishedAT&language=en&apiKey=Enter_Your_API_key";
        ...
        call.enqueue(new Callback<NewsModal>() {
            ...
            public void onFailure(Call<NewsModal> call, Throwable t) {
                Toast.makeText(MainActivityNews.this, "FAIL TO GET NEWS", Toast.LENGTH_SHORT).show();
